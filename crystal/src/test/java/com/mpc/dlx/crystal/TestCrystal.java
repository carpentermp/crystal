...
//  @Before
//  public void setUp() {
//    crystal = new Crystal("/Users/carpentermp/Downloads/neighbors.txt");
//  }
...
//    assertEquals(38, goToEnd(crystal.getNode(23), Direction.DownLeft).getId());
//    assertEquals(23, goToEnd(crystal.getNode(38), Direction.UpRight).getId());
//    assertEquals(45, goToEnd(crystal.getNode(16), Direction.Left).getId());
//    assertEquals(16, goToEnd(crystal.getNode(45), Direction.Right).getId());
//    assertEquals(60, goToEnd(crystal.getNode(1), Direction.DownRight).getId());
//    assertEquals(1, goToEnd(crystal.getNode(60), Direction.UpLeft).getId());
//  }
